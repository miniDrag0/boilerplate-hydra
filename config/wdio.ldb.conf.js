...
const appiumPort = parseInt(process.env.PORT_LDB, 10) || 4726;
exports.config = {
    // ====================
    ...
    beforeSession: function (capabilities, specs) {
        ...
        const uninstallServerCommand = 'adb -s ' + process.env.DEVICE_LDB + ' uninstall io.appium.uiautomator2.server';

        // Perintah untuk uninstall uiautomator2.server.test
        const uninstallServerTestCommand = 'adb -s ' + process.env.DEVICE_LDB + ' uninstall io.appium.uiautomator2.server.test';
